...
import { Trees, Lock, Mail, User } from 'lucide-react';
    ...
    <div className="fade-in container" style={{ 
      ...
      <div className="form-card" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '35px' }}>
          ...
          <h2 style={{ fontSize: '1.6rem', fontFamily: '"Outfit", sans-serif', fontWeight: '600' }}>Create An Account</h2>
          <p style={{ color: 'var(--light-text)', fontSize: '0.9rem' }}>Join us and discover unique forest retreats</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '25px', fontSize: '0.9rem', color: 'var(--light-text)' }}>
          Already have an account? <Link to="/login" style={{ color: 'var(--primary-medium)', fontWeight: '600', textDecoration: 'underline' }}>Log In</Link>
        </div>
      </div>
    </div>
  );
